    ...
    return (
        <StyledCardProduct {...props}>
            <Flex flexDirection="column" alignItems="center" justifyContent="center">
                {isMobile ?
                    (<Image src={product.image} alt="product" borderRadius="24px"
                        height="14rem" width="100%" objectFit="scale-down"
                        backgroundColor={theme.colors.white} margin="0 0 1rem" padding="1rem" />) :
                    (<Image src={product.image} alt="product" borderRadius="24px"
                        height="18rem" width="100%" objectFit="scale-down"
                        backgroundColor={theme.colors.white} margin="0 0 1rem" padding="1rem" />)
                }
